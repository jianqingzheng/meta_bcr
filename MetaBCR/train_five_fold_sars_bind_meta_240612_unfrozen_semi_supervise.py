...
'''
import argparse
import config_five_fold_sars_bind_meta_240612_unfrozen_semi_supervise as _cfg_
...
from MetaBCR.dataset_sars import Ab_Dataset, Ab_Dataset_mean_teacher
...
def train(num_fold=None):
    ...
    for fold in all_folds:
        ...
        fdir_train_sars_1 = _cfg_.root_dir + f'data/20240611_rbd_flu_hiv_trainmeta_data/20240621-abag_sars_trainmeta_pos_fold{fold}_randomseed-3.xlsx'
        fdir_train_sars_0 = _cfg_.root_dir + f'data/20240611_rbd_flu_hiv_trainmeta_data/20240621-abag_sars_trainmeta_neg_fold{fold}_randomseed-3.xlsx'

        fdir_train_nolabel = _cfg_.root_dir + 'data/1222_merged_A1-A11_BCR.xlsx'

        fdir_val_sars_0 = _cfg_.root_dir + f'data/20240611_rbd_flu_hiv_trainmeta_data/20240702-abag_sars_valnega_neg_fold{fold}_randomseed-3.xlsx'
        fdir_val_sars_1 = _cfg_.root_dir + f'data/20240611_rbd_flu_hiv_trainmeta_data/20240702-abag_sars_valnega_pos_fold{fold}_randomseed-3.xlsx'
        ...
        fdir_tst_sars = _cfg_.root_dir + f'data/20240510_rbd_flu_hiv_test_data/sars_unique_test_randomseed-{_cfg_.hiv_split_seed}.xlsx'
        fdir_tst_bind_0611 = _cfg_.root_dir + "data/Benchmark_rbd_bind_0611.xlsx"
        ...
        data_test_rbd = read_table(fdir_tst_sars)
        test_name = 'TEST_RBD'
        ...
        for epoch in range(_cfg_.num_epochs):
            ...
            if _cfg_.benchmark == 'acc':
                if (epoch >= _cfg_.saveaft or epoch == 0) and (eval_confusion_val[0] > best_val_acc):
                    ...
                    model.eval()
                    predictions_tst, labels_tst, lossweight_tst = implement(model, test_loader_bind_0611)
                    model.train()
