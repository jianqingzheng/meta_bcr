...
'''
import argparse
import config_five_fold_flu_neu_meta_240903_unfrozen_semi_supervise as _cfg_
...
def train(num_fold=None):
    ...
    for fold in all_folds:
        ...
        fdir_train_flu_1 = _cfg_.root_dir + f'20240902_flu_neu/20240902-abag_flu-neu_trainmeta_pos_fold{fold}_randomseed-3.xlsx'
        fdir_train_flu_0 = _cfg_.root_dir + f'20240902_flu_neu/20240902-abag_flu-neu_trainmeta_neg_fold{fold}_randomseed-3.xlsx'

        # fdir_train_flu_1 = _cfg_.root_dir + '20240902_flu_neu/20240902-abag_flu-neut_trainmeta-Influenza_pos.xlsx'
        # fdir_train_flu_0 = _cfg_.root_dir + '20240902_flu_neu/20240902-abag_flu-neut_trainmeta-Influenza_neg.xlsx'

        fdir_train_nolabel = _cfg_.root_dir + 'data/1025_all_merged_QIV_bcrs.xlsx'

        fdir_val_flu_0 = _cfg_.root_dir + f"data/20240510_rbd_flu_hiv_train_data/20240510-abag_flu-neu_val_neg_fold{fold}_unique_randomseed-{_cfg_.hiv_split_seed}.xlsx"
        fdir_val_flu_1 = _cfg_.root_dir + f"data/20240510_rbd_flu_hiv_train_data/20240510-abag_flu-neu_val_pos_fold{fold}_unique_randomseed-{_cfg_.hiv_split_seed}.xlsx"
        ...
        fdir_tst_flu = _cfg_.root_dir + '20240902_flu_neu/20240904_flu_neut_benchmark_o_jiangsu.xlsx'
        ...
        if _cfg_.pretrain_model_dir is not None:
            ...
            print('Loading state dict: {}'.format(_cfg_.pretrain_model_dir))
