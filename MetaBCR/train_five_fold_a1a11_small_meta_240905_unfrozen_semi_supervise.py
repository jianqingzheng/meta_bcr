...
2024.06.21
'''
import config_five_fold_a1a11_small_meta_240905_unfrozen_semi_supervise as _cfg_
...
def train(num_fold=None):
    all_folds = [2,1,3,0,4] if num_fold==None else [num_fold]
    ...
    for fold in all_folds:
        ...
        fdir_train_sars_1 = _cfg_.root_dir + f"data/20240611_rbd_flu_hiv_trainmeta_data/20240521-abag_sars-neu_trainmeta-A1A11-batch123_pos.xlsx"
        fdir_train_sars_0 = _cfg_.root_dir + f"data/20240611_rbd_flu_hiv_trainmeta_data/20240521-abag_sars-neu_trainmeta-A1A11-batch123_neg.xlsx"
        ...
        fdir_tst_neu_0104 = _cfg_.root_dir + f'data/20240510_rbd_flu_hiv_test_data/sars_unique_test_randomseed-{_cfg_.hiv_split_seed}.xlsx'
            ...
            if _cfg_.benchmark == 'acc':
                if (epoch >= _cfg_.saveaft or epoch == 0) and (eval_confusion_val[0] > best_val_acc):
                    ...
                    data_test_neu_0104.to_excel(
                        _cfg_.root_dir + f"{_cfg_.date_step}_rbd_neu_results_semi/{test_name_0104}_{model_name}_rbd_neu_0104_test.xlsx",
                        index=False,
                        header=True)
