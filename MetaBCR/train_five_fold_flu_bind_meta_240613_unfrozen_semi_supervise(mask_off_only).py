...
def train():
    for fold in range(5):
        ...
        fdir_train_flu_1 = 'data/20240611_rbd_flu_hiv_trainmeta_data/20240613-abag_flu-bind_trainmeta-Influenza_pos.xlsx'
        fdir_train_flu_0 = 'data/20240611_rbd_flu_hiv_trainmeta_data/20240613-abag_flu-bind_trainmeta-Influenza_neg.xlsx'
        ...
        data_train_flu_antigen_for_unlabel = pd.concat([data_train_flu_1, data_train_flu_0], ignore_index=True)
        ...
        train_set = Ab_Dataset_mean_teacher(datalist=[data_train_flu_1,
                                                     ...
                                                     [data_train_flu_1, data_train_non_experiment_flu],
                                                      [data_train_nolabel, data_train_flu_antigen_for_unlabel]
                                                      ],
