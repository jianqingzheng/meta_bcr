...
2024.06.21
'''
import config_five_fold_sars_neu_small_meta_241007_unfrozen_semi_supervise as _cfg_
...
def train(num_fold=None):
    ...
    for fold in all_folds:
        ...
        fdir_train_sars_1 = _cfg_.root_dir + f'data/20240909_rbd_neut_trainmeta_data/20240909-abag_sars-neu-new_trainmeta_pos.xlsx'
        fdir_train_sars_0 = _cfg_.root_dir + f'data/20240909_rbd_neut_trainmeta_data/20240909-abag_sars-neu-new_trainmeta_neg.xlsx'

        fdir_train_nolabel = _cfg_.root_dir + 'data/20240909_nc_new_sars_neut_all_bcrs.csv'

        fdir_val_sars_0 = _cfg_.root_dir + f'data/20240909_rbd_neut_trainmeta_data/20240909-abag_sars-neu-new_trainmeta_pos.xlsx'
        fdir_val_sars_1 = _cfg_.root_dir + f'data/20240909_rbd_neut_trainmeta_data/20240909-abag_sars-neu-new_trainmeta_neg.xlsx'
            ...
            if _cfg_.benchmark == 'acc':
                if (epoch >= _cfg_.saveaft or epoch == 0) and (eval_confusion_val[0] > best_val_acc):
                    ...
                    data_test_neu_0909.to_excel(
                        _cfg_.root_dir + f"{_cfg_.date_step}_rbd_neu_small_results_semi/{test_name_0909}_{model_name}_rbd_binding_test.xlsx",
                        index=False,
                        header=True)
