...
def train(num_fold=None, _cfg_=None, antigen_name='rsv',task_name='bind'):
    ...
    for fold in all_folds:
        ...
        fdir_sc_sars = "Data/RSV/1222_merged_A1-A11_BCR.xlsx"  ### 250218
        fdir_sc_flu = "Data/RSV/1025_all_merged_QIV_bcrs_final.xlsx"  ### 250218
        ...
        fdir_train_non_experiment_cross = [fdir_sc_sars,fdir_sc_flu,fdir_train_non_experiment_flu, fdir_train_non_experiment_sars, fdir_train_non_experiment_hiv]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--antigen_name', type=str, default='rsv')
    parser.add_argument('--task_name', type=str, default='bind')
    parser.add_argument('--config_date', type=str, default='250222')
